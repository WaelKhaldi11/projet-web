        ...
        <div class="menu-item-carousel">
            <div class="col-lg-12">
                <div class="owl-menu-item owl-carousel">
                    ...
                    <div class="item">
                        <div class='card' style="background-image:  url({{ $voiture->photo }})">
                            <div class="price"><h6>${{$voiture->prix_jour}}</h6></div>
                            <div class='info'>
                              <h1 class='title'>{{$voiture->marque}}</h1>
                              <p class='description'>{{$voiture->modele}}</p>
